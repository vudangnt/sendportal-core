...
{
    protected $table = 'sendportal_industries';
    ...
    {
        return $this->belongsToMany(Campaign::class, 'sendportal_campaign_industry');
    }

    public function subscribers(): BelongsToMany
    {
        return $this->belongsToMany(Subscriber::class, 'sendportal_industry_subscriber')->withTimestamps();
    }
    ...
    public function getTotalActiveSubscribersCountAttribute(): int
    {
        ...
        $uniqueSubscriberIds = DB::table('sendportal_industry_subscriber')
            ->whereIn('industry_id', $allIds)
            ->distinct()
            ->pluck('subscriber_id');
