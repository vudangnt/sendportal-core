...
@section('content')
    ...
    <style>
        .max-width-200 {
            ...
            /* Ensure long words break to fit within the width */
        }
        ...
        .locations-content {
            display: block;
            /* Always show Locations content */
        }

        .text-container.expanded .tags-content {
            white-space: normal;
            /* Allow full text to show when expanded */
        }
                        ...
                        <tr>
                            <td>
                                ...
                                @elseif($campaign->sent)
                                    <a
                                        href="{{ route('sendportal.campaigns.reports.index', $campaign->id) }}">{{ $campaign->name }}</a>
                                @else
                            ...
                            @endif
                            <td><span title="{{ $campaign->created_at }}">{{ $campaign->created_at->diffForHumans() }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($campaign->draft)
                                            <a href="{{ route('sendportal.campaigns.edit', $campaign->id) }}" class="dropdown-item">
                                                {{ __('Edit') }}
                                            </a>
                                        @else
