...
exampleTemplates.restaurant_menu.body.rows[1].columns[0].contents[0].values.text = "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 28px; line-height: 39.2px;\"><strong>🍽️ New Menu is Here!</strong></span></p>";
...
exampleTemplates.tech_onboarding.body.rows[1].columns[0].contents[0].values.text = "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 28px; line-height: 39.2px;\"><strong>☁️ Welcome to [Product]!</strong></span></p>";
...
exampleTemplates.legal_newsletter.body.rows[1].columns[0].contents[0].values.text = "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 28px; line-height: 39.2px;\"><strong>⚖️ Legal Update</strong></span></p>";
...
exampleTemplates.travel_destination.body.rows[1].columns[0].contents[0].values.text = "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 28px; line-height: 39.2px;\"><strong>✈️ Exclusive Travel Deals</strong></span></p>";
...
exampleTemplates.nonprofit_donation.body.rows[1].columns[0].contents[0].values.text = "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 28px; line-height: 39.2px;\"><strong>❤️ Make a Difference Today</strong></span></p>";
